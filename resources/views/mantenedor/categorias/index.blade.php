                        ...
                        @else
                            @foreach ($categorias as $itemcategoria)
                                <tr>
                                    ...
                                    <td><a href="{{route('categorias.edit',$itemcategoria->idcategoria)}}" class="btn btn-info btn-sm"><i class="fas fa-edit"></i> Editar</a>
                                        <a href="{{route('categorias.confirmar',$itemcategoria->idcategoria)}}" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i>
                                            Eliminar</a>
                                    </td>
